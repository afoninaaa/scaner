...
def run_file():
    ...
    try:
        ...
        return str(e), False
    execution.execute_commands_run(emergency_stop_event, client, table_data)
    return redirect(url_for('index'))
...
def upload_py_file():
    ...
    if file and file.filename.endswith('.py'):
        filepath = f'user_code/{file.filename}'
        file.save(filepath)
...
def load_and_run_from_file():
    ...
    try:
        ...
        return str(e), False
    execution.execute_commands_prepare_dev(client, table_data, emergency_stop_event)
    return redirect(url_for('index'))
...
def save_code():
    ...
    code = data['code']
    with open('user_code/user_code.py', 'w') as f:
        f.write(code)
